...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/party-mode/workflow.md with the current project context
