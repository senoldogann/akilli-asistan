...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/advanced-elicitation/workflow.xml with current patterns
...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/party-mode/workflow.md with implementation patterns context
