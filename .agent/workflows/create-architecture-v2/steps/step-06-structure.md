...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/advanced-elicitation/workflow.xml with current project structure
...
- Read fully and follow: {project-root}/.agent/.shared/bmad-lib/core/workflows/party-mode/workflow.md with project structure context
